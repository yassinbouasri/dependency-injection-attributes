...
1. Es perezoso por defecto.
2. Es más flexible porque devuelve el objeto de servicio completo.
3. Y, con docblocks adecuados, obtenemos: autocompletado, navegación por métodos, soporte de refactorización y un mejor análisis estático con herramientas como PhpStan.
