...
`#[AutowireCallable]` es ciertamente genial, pero para la mayoría de los casos, prefiero utilizar`#[AutowireServiceClosure]` porque: Es perezoso por defecto. Es más flexible porque devuelve el objeto de servicio completo. Y, con los bloques de documentación adecuados, obtenemos : Autocompletado Navegación de métodos Soporte de refactorización* Y un mejor análisis estático con herramientas como PhpStan
